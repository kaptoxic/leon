...
//  val pairClass = program.caseClassDef("Pair")
...
//  val splitFun = program.definedFunctions.find(_.id.name == "split").get
//  
//  val nil = nilExp
...
//  
//  val synthesizer = new Synthesizer(codeGenEval, funDef)
//
//  import AndOrGraph._
//  import StepGraph._
...
////      root.isSolved should be (true)
////      println("Step tree: " + FormatStepGraph(root, true))
////
